    ...
    <Nav>
      <div className={ menuIcon ? "navbar active" : "navbar"}>
        <ul className="navbar-lists">
            ...
            <li>
                <NavLink to="/about" className="navbar-link" onClick={() => setMenuIcon(false)}>Fibre Aplications</NavLink>
            </li>
            <li>
                <NavLink to="/product" className="navbar-link" onClick={() => setMenuIcon(false)}>Shop</NavLink>
            </li>
            <li>
